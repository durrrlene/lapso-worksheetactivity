...
#therefore I downloaded a .csv file from the internet. Link where I get the 'Titanic.csv': https://github.com/datasciencedojo/datasets/blob/master/titanic.csv
